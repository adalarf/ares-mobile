...
import { getStatsInfo } from "../hooks/useMainRequests";
import NavigationService from "../services/navigationService";

export const PollComplete = ({ navigation, route }) => {
  const { poll_stats } = route.params;

  console.log("PollComplete poll_stats", poll_stats);
  return (
    <ImageBackground
    ...
    >
      <View style={styles.header}>
        <TouchableOpacity
          onPress={async () => {
            await getStatsInfo();
            NavigationService.reset("mainPage", 0);
          }}
        >
          <Image
        ...
        >
          ...
          <View style={styles.textContainer}>
            <View style={styles.row}>
              ...
              <View style={styles.row}>
                <Text style={[styles.exerciseText, typography.bounded]}>
                  {get(poll_stats, "total_questions", 0)}
                </Text>
                <Image
            ...
            <View style={styles.row}>
              ...
              <View style={styles.row}>
                <Text style={[styles.exerciseText, typography.bounded]}>
                  {get(poll_stats, "correct_answers", 0)}
                </Text>
                <Image
                  source={require("../assets/done.png")}
                  style={styles.icon}
            ...
            <View style={styles.row}>
              ...
              <View style={styles.row}>
                <Text style={[styles.exerciseText, typography.bounded]}>
                  {get(poll_stats, "accuracy_percentage", 0)}%
                </Text>
                <Image
                  source={require("../assets/done.png")}
                  style={styles.icon}
          ...
          <View style={[styles.row, { paddingHorizontal: 10 }]}>
            <Text style={[textStyles.buttonText, typography.bounded]}>
              {get(poll_stats, "total_expirience", 0)} XP
            </Text>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <Text style={[textStyles.buttonText, typography.bounded]}>
                {get(poll_stats, "total_gems", 0)}
              </Text>
              <Image
